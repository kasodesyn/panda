          ...
          <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg tracking-tight">
                GET ONE “Voyager Panda ”NFT! subsequent version NFT discounts and priority purchase qualifications, and future pledge rewards
              </p>
            </div>
            <form>
              ...
              <div className="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-blue-900/5 focus-within:ring-2 focus-within:ring-blue-900">
                ...
                <Button type="submit" onClick={()=>setIsClick(true)}>
                  <span className="sr-only sm:not-sr-only">{isClick?"Success ✅":" Subscribe"}</span>
